                        ...
                        <div className='col-md-3'>
                            <div className='card shadow border-0 mb-3'>
                                <div className='card-body p-4'>
                                    ...
                                    <h3 className='mt-4'>You can writte us:</h3>
                                    <div>
                                        <a href="#">urbanedge@gmail.com</a>
                                    </div>
                                    <div>
                                        <a href="#">urbanedge@gmail.com</a>
                                    </div>
                                    ...
                                    <div>
                                        B-18X, Strip, Downtown <br/>
                                        Nevada, Strip, Downtown <br/>
                                        885-607-45
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className='card-body p-5'>
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        <div className='row'>
                                            ...
                                            <div>
                                                <label htmlFor="form-label">Message</label>
                                                <textarea
                                                {
                                                    ...register('message')
                                                }
                                                placeholder='Message' rows={5} id="" className='form-control form-control-lg'></textarea>
                                            </div>
                                        </div>
